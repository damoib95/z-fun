...
def enviargrafica():
    ...
    #Adjuntar Imagen
    file=open("/Users/DiegoMorales/Dropbox/z-Fun4A2.5/"+Grafica,"rb")
...
while Program==True:    
    ...
    if grado==1:
        ...
        print "\nFuncion:[a]X + ind"
        a1=input("Valor coeficiente a de X: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a1),"X + [ind]"
        ind=input("Valor independiente: ")
    ...
    if grado==2:
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:[a]X2 + bX + ind"
        a2=input("Valor coeficiente a de X a la 2: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a2),"X2 +[b]X + ind"
        a1=input("Valor coeficiente b de X: ")
        #Se imprime la funcion indicando el dato a asignar
    ...
    if grado==3:
        ...
        a3=input("Valor coeficiente a de X a la 3: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a3),"X3 + [b]X2 + cX +ind"
        a2=input("Valor coeficiente b de X a la 2: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a3),"X3 + ",(a2),"X2 + [c]X +ind"
        a1=input("Valor coeficiente c de X: ")
        #Se imprime la funcion indicando el dato a asignar
    ...
    if grado==4:
        ...
        a4=input("Valor coeficiente a de X a la 4: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a4),"x4 + [b]x3 + cx2 + dx + ind"
        a3=input("Valor coeficiente b de X a la 3: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a4),"x4 + ",(a3),"x3 + [c]x2 + dx + ind"
        a2=input("Valor coeficiente c de X a la 2: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a4),"x4 + ",(a3),"x3 + ",(a2),"x2 + [d]x + ind"
        a1=input("Valor coeficiente d de X: ")
        #Se imprime la funcion indicando el dato a asignar
    ...
    if grado==5:
        ...
        a5=input("Valor coeficiente a de X a la 5: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a5),"x5 + [b]x4 + cx3 + dx2 + ex + ind"
        a4=input("Valor coeficiente b de X a la 4: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a5),"x5 + ",(a4),"x4 + [c]x3 + dx2 + ex + ind"
        a3=input("Valor coeficiente c de X a la 3: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a5),"x5 + ",(a4),"x4 + ",(a3),"x3 + [d]x2 + ex + ind"
        a2=input("Valor coeficiente d de X a la 2: ")
        #Se imprime la funcion indicando el dato a asignar
        print "\nFuncion:",(a5),"x5 + ",(a4),"x4 + ",(a3),"x3 + ",(a2),"x2 + [e]x + ind"
        a1=input("Valor coeficiente e de X: ")
        #Se imprime la funcion indicando el dato a asignar
